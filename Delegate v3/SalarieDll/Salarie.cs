...
namespace SalarieDll
{
    ...
    public class Salarie
    {
        ...
        private void OnChangementSalaire(object sender, ChangementSalaireEventArgs e)
        {
            if (ChangementSalaire != null)
            {
                ChangementSalaire(sender, e);
            }
        }
        ...
        public virtual decimal SalaireBrut2
        {
            get
            {
                return _salaireBrut;
