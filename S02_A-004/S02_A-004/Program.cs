...
namespace S02_A_004
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            saisieInformationsMarital(ref etatMarital);
            saisieNbEnfants(ref nbMioches);
            saisieSalaire(ref salaire);
            
            //calule des taux

            definitionTaux(ref etatMarital, ref nbMioches, ref taux, ref salaire);

            //Affichage du resultat

            affichageTaux(ref taux);
        ...
        static void saisieInformationsMarital(ref int etatMarital)
        {
            //*******************************************************************
        ...
        private static void saisieNbEnfants(ref int nbMioche)
        {
            //*******************************************************************
        ...
        private static void definitionTaux(ref int etatMarital, ref int nbMioches, ref double taux, ref int salaire)
        {
            //*******************************************************************
            //*                     Définition du taux                          *
            //*******************************************************************
        ...
        private static void affichageTaux(ref double taux)
        {
            //*******************************************************************
            //*                      Affichage du taux                          *
            //*******************************************************************
        ...
        private static void saisieSalaire(ref int salaire)
        {
            //*******************************************************************
            //*                      Saisie du salaire                          *
            //*******************************************************************
