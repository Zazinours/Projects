...
namespace SalarieDll
{
    ...
    public class SalaireChanger_EventArgs : EventArgs
    {

        /// declaration du type salaireChanger

        delegate void salaireChanger();

        // declaration variable du type salaireChanger

        private salaireChanger appelMethodes = null;
        private readonly salaireChanger MethodeA;
        private readonly salaireChanger MethodeB;

        private salaireChanger MethodeA1
        {
            get
            {
                return MethodeA;
        ...
        private salaireChanger MethodeB1
        {
            get
            {
                return MethodeB;
        ...
        public void salaireChanger_TextChanged(object sender, EventArgs e)
        {

            appelMethodes += new salaireChanger(MethodeA1);
            appelMethodes += new salaireChanger(MethodeB1);
